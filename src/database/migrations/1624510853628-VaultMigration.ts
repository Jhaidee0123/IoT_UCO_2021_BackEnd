...
export class VaultMigration1624510853628 implements MigrationInterface {
    name = 'VaultMigration1624510853628'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "user_role_enum" AS ENUM('POWER_USER', 'MANAGER', 'USER', 'WATCHMAN')`);
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "vaultName" character varying, "email" character varying NOT NULL, "password" character varying NOT NULL, "pin" integer, "role" "user_role_enum" NOT NULL DEFAULT 'POWER_USER', "imageRoute" character varying, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
